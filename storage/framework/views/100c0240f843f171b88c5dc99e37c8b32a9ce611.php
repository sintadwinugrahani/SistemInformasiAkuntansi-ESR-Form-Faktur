                                ...
                                <table id="table" class="display table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Tanggal Nota Debit</th>
                                            ...
                                            <th class="text-center">No WHT</th>
                                            <th class="text-center">Tanggal WHT</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <?php echo e(date('d-M-Y', strtotime($item->debit_note_date))); ?></td>
                                                ...
                                                <td class="text-center"><?php echo e($item->tax_invoice_serial_no); ?></td>
                                                <td class="text-center">
                                                    <?php echo e(date('d-M-Y', strtotime($item->tax_invoice_date))); ?></td>
                                                <td class="text-center"><?php echo e($item->wht_no); ?></td>
                                                <td class="text-center"><?php echo e(date('d-M-Y', strtotime($item->wht_date))); ?>
...
<?php echo $__env->make('components.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\SIA\laravel-finance-form\resources\views/report/debit.blade.php ENDPATH**/ ?>