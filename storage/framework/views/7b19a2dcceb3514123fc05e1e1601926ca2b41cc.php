                    ...
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <?php if(auth()->user()->role != 'supervisor'): ?>
                                <a href="<?php echo e(route('payment.create')); ?>" class="btn btn-primary btn-round ml-auto">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="d-flex flex-row justify-content-between align-items-center">
                                    <div class="d-flex flex-column align-items-start">
                                        <span>Tertunda</span>
                                        <button class="btn btn-info btn-sm mt-1" id="btn1">Tertunda</button>
                                    </div>
                                    <div class="d-flex flex-column justify-content-center">
                                        <span>Dalam Proses</span>
                                        <button class="btn btn-warning btn-sm mt-1" id="btn2">Dalam Proses</button>
                                    </div>
                            ...
                            <table id="table" class="display table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">Tanggal Voucher Permintaan Pembayaran</th>
                                        <th class="text-center">No Voucher Permintaan Pembayaran</th>
...
<?php echo $__env->make('components.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ASUS\Documents\SIA\laravel-finance-form\resources\views/payment_request/index.blade.php ENDPATH**/ ?>